...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        if (IS_IOS9) {
            [[UINavigationBar appearance] setBackgroundImage:[UIImage createImageWithColor:kNavigationBarColor] forBarMetrics:UIBarMetricsDefault];
            [self.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:kNavigationTitleColor, NSForegroundColorAttributeName, nil]];
        }
        else
        {
